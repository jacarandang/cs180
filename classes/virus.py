...
class Fungi(VirusSprite):
	...
	def __init__(self, board, thing, res, life=10):
...
class Parasite(VirusSprite):
	...
	def __init__(self, board, thing, res, life=20):
...
class Bacteria(VirusSprite):
	...
	def __init__(self, board, thing, res, life=80):
...
class Virus(VirusSprite):
	...
	def __init__(self, board, thing, res, life=50):
...
class Ebola(VirusSprite):
	...
	def __init__(self, board, thing, res, life=40):
